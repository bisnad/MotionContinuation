...
for run_id in range(num_divergent_runs):
    ...
    export_sequence_anim(pred_sequence, "results/anims/pred_sequence_epoch_{}_seq_start_{}_length_{}_run_{}.gif".format(epochs, seq_start, seq_length, run_id))
    export_sequence_fbx(pred_sequence, "results/anims/pred_sequence_epoch_{}_seq_start_{}_length_{}_run_{}.fbx".format(epochs, seq_start, seq_length, run_id))