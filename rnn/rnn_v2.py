...
mocap_valid_frame_ranges = [ [ [ 440, 6550 ] ] ]  # in seconds
mocap_pos_scale = 1.0
mocap_fps = 50
...
def train_step(pose_sequences, target_poses, teacher_forcing):
    ...
    if teacher_forcing:
        ...
        _pred_poses_full = rnn(_full_input, return_sequence=True)
        
        _pred_poses_for_loss = _pred_poses_full[:, -output_poses_length:, :]
