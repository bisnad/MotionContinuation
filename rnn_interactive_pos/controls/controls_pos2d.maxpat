...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 697.75, 593.0, 182.0, 22.0 ],
					"text" : "/mocap/changejointpos $1 $2 $3"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 249.0, 231.7236328125, 206.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 251.25, 339.0, 72.75, 20.0 ],
					"text" : "Repeat"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 697.75, 553.0, 78.0, 22.0 ],
					"text" : "pak 1 0.1 0.1"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 249.0, 261.0, 75.0, 20.0 ],
					"text" : "Joint Index"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 251.25, 314.0, 72.75, 20.0 ],
					"text" : "Position"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 334.5, 261.0, 50.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 240.833333333333485, 593.0, 159.0, 22.0 ],
					"text" : "/mocap/setjointpos $1 $2 $3"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 12.0, 231.7236328125, 206.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 14.25, 339.0, 72.75, 20.0 ],
					"text" : "Repeat"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 126.75, 553.0, 78.0, 22.0 ],
					"text" : "pak 1 0.1 0.1"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 12.0, 261.0, 75.0, 20.0 ],
					"text" : "Joint Index"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 14.25, 314.0, 72.75, 20.0 ],
					"text" : "Pos"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 97.5, 261.0, 50.0, 22.0 ],
					"varname" : "joint_index"
				}
